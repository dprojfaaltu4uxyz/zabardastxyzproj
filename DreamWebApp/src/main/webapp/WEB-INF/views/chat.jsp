...
<script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="<c:url value='/static/js/jquery.atmosphere.js' />"></script>
    <script type="text/javascript" src="<c:url value='/static/js/atmosphere.js' />"></script>
</body>
</html>
